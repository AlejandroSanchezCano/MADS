...
class Database(abc.ABC):
    ...
    @classmethod
    def in_database(cls) -> Generator['Interactor', None, None]: # WAR : problem with interactor and circular import
        '''
    ...
    def save(cls, df: pd.DataFrame, type: Literal['all', 'MADS'] = 'MADS') -> None:
        ...
        df.to_pickle(f'{var.NETWORKS}/{cls.database}_MADS vs {type}.pkl')