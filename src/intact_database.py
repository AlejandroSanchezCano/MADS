...
class IntAct(Database):
    ...
    def mads_vs_all(self, type: Literal['+', '-'] = '+') -> pd.DataFrame:
        ...
        type : Literal['+', '-'], optional
            Type of interactions to be retrieved. '+' retrieves positive 
            interactions, '-' retrieves negative interactions. Default is '+'.
        ...
        file_path = f'{IntAct.path}/intact{type_network}.txt'
